      ...
      <div className="Dashboard" class="grid grid-cols-5">
        <div className="LeftSide" class="col-span-4 ml-10  mb-10">
          ...
          <div class="grid grid-rows-2 grid-cols-1 md:grid-cols-3 gap-4 mt-5">
            <div
              className="Weekly"
              class="grid font-ttest w-full h-full bg-white mx-auto pl-10 md:p-12 my-auto rounded-lg shadow-xl "
            >
            ...
            >
              ...
              <div>
                <div class="mt-4 grid grid-rows-3 grid-flow-col">
                  ...
                  <div class="mb-2 col-span-2 text-sm font-test">
                    Web Design
                  </div>
            ...
            <div
              className="Console"
              class="col-span-3 grid font-ttest w-full relative bg-white mx-auto pl-10 md:p-12 my-auto rounded-lg shadow-xl"
            >
              Console
            </div>
          </div>
