...
function Register(props) {
  ...
  const genRanNum = () => {
    ...
    console.log(randNum); //아하!!!!! 그렇구나!! ;
    //console.log(ranNum); 정말 유익해!
    return randNum;
  };
        ...
        <div class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
          <div>
            <h3 class="font-bold text-2xl">
              반가워요👋 Gitime에 오신 걸 환영해요!
            </h3>
            <p class="text-gray-600 pt-2">
              간단한 입력으로 회원 가입을 진행할 수 있어요!
            </p>
          </div>
          <div class="mt-10">
        ...
        <div class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
          ...
          <div class="mt-10">
            <div class="flex flex-col" method="POST" action="#">
              ...
              <div class="block text-gray-700 text-sm font-bold mt-5 mb-2 ml-3">
                생일
              </div>
              <div class="grid grid-cols-3 gap-2">
                ...
                <div class="mb-6 rounded bg-gray-200">
                  <select
                    class="pl-2 w-full h-full bg-gray-200"
                    id="birth2"
                    value={birth2}
                    onChange={onBirthHandler2}
                  >
